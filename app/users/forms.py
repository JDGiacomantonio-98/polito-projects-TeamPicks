...
class ProfileDashboardForm(FlaskForm):
	...
	firstName = StringField('Name :', validators=[DataRequired()], render_kw={'class': 'form-control'})
	lastName = StringField('Surname :', validators=[DataRequired()], render_kw={'class': 'form-control'})
