...
from app.users.methods import verify_psw
...
class DeleteAccountForm(FlaskForm):
	...
	def validate_psw(self, psw):
		if not verify_psw(current_user.pswHash, psw.data):
			raise ValidationError('Uncorrect password. After 2 more attempts your account will be temporanely blocked and notified to TeamPicks.')
